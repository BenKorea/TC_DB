...
patient_risk_summary <- patient_TT[,
  .(pt_id, pt_name, first_tx, fu_loss, last_visit, recurrence_date, recur, Risk, op_date, cN,   
...
px[is.na(M), M := "M0"]
px[is.na(operator), operator := "KCCH"]
px[str_detect(operator,"@"), operator := "outside"]
...
px <- px[,.(pt_id, age, sex, op_year, operator, Risk, histology, subtype, pT, size, Multiplicity, ETE, gross_ETE, pN, ENE, time, recur)]
```
